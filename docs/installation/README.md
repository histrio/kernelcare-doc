...
:::warning Note
BETA version of KernelCare package with KC+ functionality is available as [rpm](http://patches04.kernelcare.com/userspace/kernelcare-2.32-1.el7.1595920539.56067.28.x86_64.rpm) and [deb](https://patches04.kernelcare.com/userspace/kernelcare_2.32-1.1599206356.56067.32_amd64.deb) files.
:::
